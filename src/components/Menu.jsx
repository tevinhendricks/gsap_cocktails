...
export default function Menu() {
    ...
    useGSAP(() => {
        ...
        gsap.fromTo('.cocktail_img', { opacity:0, xPercent: -100}, { xPercent:0, opacity:1, duration:1, ease: 'power1.inOut'});
    ...
    return (
        <section id="menu" aria-labelledby="menu-heading">
            ...
            <h2 id="men-heading" className="sr-only">Cocktail Menu</h2>
            ...
            <div className="content">
                ...
                <div className="cocktail">
                    <img src={currentCocktail.image} className="object-contain cocktail_img" />
                </div>
